...
export default function BoardWrite() {
    ...
    // event handler: 게시물 내용 변경 이벤트 처리
    ...
    // render: 게시물 수정 페이지 컴포넌트 렌더링
    return (
        <div id='board-update-wrapper'>
            <div className='board-update-container'>
                <div className='board-update-box'>
                    <div className='board-update-title-box'>
                        <textarea ref={titleRef} className='board-update-title-textarea' rows={1} placeholder='제목을 작성해주세요.' value={title}
